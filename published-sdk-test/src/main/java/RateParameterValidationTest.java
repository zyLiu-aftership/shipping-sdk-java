...
import com.aftership.shipping.rates.*;
...
public class RateParameterValidationTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=====================================");
        System.out.println("AfterShip Shipping SDK Rate 参数验证测试套件 (发布包 3.0.0)");
        System.out.println("=====================================");
    ...
    private PostRatesRequest createParameterTestRequest(TestCase testCase) {
        ...
        // request.setReturnShipment(false); // 发布包中可能没有此方法
    ...
    private void printTestSummary() {
        ...
        if (passedTests == totalTests) {
            ...
            System.out.println();
            System.out.println("✅ Shipping SDK 枚举值和参数设置功能正常（发布包 3.0.0）");
